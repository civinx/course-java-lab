...
public interface Constants {
    ...
    String ATTRIBUTE_RECORD_LIST = "ATTRIBUTE_RECORD_LIST";
    String ATTRIBUTE_LAB = "ATTRIBUTE_LAB";
    String ATTRIBUTE_USER_OPTION = "ATTRIBUTE_USER_OPTION";

    // ALERT_INFO
    String ALERT_INPUT_SHOULD_BE_NUMBER = "ALERT_INPUT_SHOULD_BE_NUMBER";
    String ALERT_COMPUTER_ID_SHOULD_BE_NUMBER = "ALERT_COMPUTER_ID_SHOULD_BE_NUMBER";
    String ALERT_COMPUTER_LAST_IP_SHOULD_BE_NUMBER = "ALERT_COMPUTER_LAST_IP_SHOULD_BE_NUMBER";
    String ALERT_USER_NAME_ALREADY_EXIST = "ALERT_USER_NAME_ALREADY_EXIST";
    ...
    String ALERT_LAB_GATE_SHOULD_BE_NUMBER = "ALERT_LAB_GATE_SHOULD_BE_NUMBER";
    String ALERT_COMPUTER_IP_USED = "ALERT_COMPUTER_IP_USED";
