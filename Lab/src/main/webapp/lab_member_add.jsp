        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">添加实验室成员</h3>
                </div>
                    ...
                    <form method="get" action="/home/lab/member/add_action">
                        <fieldset id="add-form">
                            ...
                            <div class="form-group">
                                ...
                                <%
                                List<User> userList = (List) request.getAttribute(Constants.ATTRIBUTE_USER_OPTION);
                                if (userList != null)
                            ...
                            <input id="add-btn" value="添加" class="btn btn-lg btn-success btn-block" type="submit">
                        </fieldset>
                    </form>
                </div>
            </div>
